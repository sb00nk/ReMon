...
Questo comando richiede che il file hosts sia già stato configurato per l'utilizzo in locale, ovvero 
compilato con solo il nome di sistema del computer dal quale si sta eseguendo.
